...
SELECT
    ...
    AVG(CASE WHEN itemid = 223762 THEN average_valuenum ELSE NULL END) AS temperature
    -- MAX(CASE WHEN itemid = 223762 AND (average_valuenum > 38 OR average_valuenum < 36) THEN 1 ELSE 0 END) AS ThermoDys
